        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black p-4">
            <div className="w-full max-w-md bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border border-white/20">
                <div className="px-8 pt-8 pb-8">
                    <h1 className="mb-2 text-3xl font-extrabold text-center text-white tracking-tight">Welcome Back</h1>
                    <p className="mb-6 text-center text-gray-400 text-sm">Sign in to access your dashboard</p>
            ...
            <p className="mt-8 text-center text-gray-600 text-xs">
                &copy; {new Date().getFullYear()} Dashboard Corp. All rights reserved.
            </p>
        </div>
    );
}
